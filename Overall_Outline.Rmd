...
1. Biology labs in R ^[Logically, this should come in the middle, but there are scheduling constraints.]
...
Back to the Bio Lab data.

Activities: Armed Forces data.  You and your team should enter data in the Google spreadsheet.
...
[Slides from Randall Pruim](../TeachingWithR/CommandTemplate/LessVolumeMoreCreativity.html)

Activity: Tell a story about `NHANES` or `GaltonHeights`
...
# Designing labs/assignments for *your* classes
